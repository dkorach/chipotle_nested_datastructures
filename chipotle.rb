...
my_order[:rice_bean_veg] << main[:rice_bean_veg][3]
...
puts 'Can I please have a ' + my_order[:style] + '. ' + 'For meat, I would like ' + my_order[:meat] + 'with ' + my_order[:rice_bean_veg] + '. ' + 'Then I would like ' + my_order[:toppings][0] + 'and ' + my_order[:toppings][1] + 'as my toppings. Thank you!'
